  ...
  return (
    <div className='mx-0 md:mx-10'>
      ...
      <div className='text-center text-2xl pt-5 md:pt-10 text-gray-500'>
        <p>
          ABOUT{' '}
          <span className='text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 via-teal-500 to-lime-500 font-medium'>
            US
          </span>
        </p>
      </div>
      ...
      <div className='my-7 md:my-10 flex flex-col items-center lg:flex-row gap-7 md:gap-12'>
        ...
        <div className='flex flex-col justify-center md:text-justify gap-4 md:gap-6 text-sm md:text-base text-gray-600'>
          ...
          <b className='text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 via-teal-500 to-lime-500 text-base md:text-xl md:mt-8'>
            Our Vision
          </b>
          <p>
      ...
      <div className='text-xl md:text-2xl my-10 md:my-2 text-gray-600 uppercase text-center'>
        <p>
          Why{' '}
          <span className='text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 via-teal-500 to-lime-500 font-semibold'>
            Choose Us
          </span>
        </p>
      </div>
      ...
      <div className='flex flex-col md:flex-row gap-4 md:gap-2 p-0 md:p-10'>
        <div className='flex flex-col gap-3 md:gap-4 px-7 py-8 md:p-12 rounded text-white shadow-md bg-gradient-to-r from-emerald-500 via-teal-500 to-lime-500 transition-all duration-150 ease-in hover:scale-[103%]'>
